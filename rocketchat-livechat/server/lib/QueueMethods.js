...
RocketChat.QueueMethods = {
	...
	'Guest_Pool'(guest, message, roomInfo) {
		...
		console.log("Department:", guest.department);
		console.log("Onlline Agents:", agents);
		console.log("All Agents:", RocketChat.Livechat.getAgents(guest.department));
		console.log("Departments: ", RocketChat.models.LivechatDepartment.find().fetch());
