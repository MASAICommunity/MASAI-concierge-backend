...
Template.livechatCurrentChats.onCreated(function() {
	...
	window.livechatCurrentChatsSelf = this;
	window.livechatCurrentChatsSelf.channels = new ReactiveVar();

	this.subscribe('livechat:agents');

	this.autorun(() => {
		
		Meteor.call('masai:getPartners', (error,result) => {
			window.livechatCurrentChatsSelf.channels.set(result.partners);
		});
